...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{DDR_linux.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{DDR_without_linux.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.4\textwidth]{IPC_linux_ARM_to_PRU.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.4\textwidth]{IPC_linux_PRU_to_ARM.png}
